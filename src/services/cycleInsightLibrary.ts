...
const library: DayInsight[] = [
  ...
  },
  {
    ...
    phase: "follicular",
    hormoneNote: [
      "Estrogen is building strongly — your body is preparing to ovulate.",
      "Estrogen surges are accelerating; ovulation is about a week away.",
      "Strong estrogen levels are driving your best physical and mental performance.",
    ],
    physicalExpectation: [
      "Physical capacity is near its weekly peak today.",
      "Strength and stamina are at their best point of the week today.",
      "Your body is running at high capacity — physical output is reliable.",
    ],
    mentalExpectation: [
      "Concentration and decision-making feel sharper than most days this cycle.",
      "Mental performance is near its monthly high — focus is effortless today.",
      "This is one of your sharpest cognitive days of the cycle.",
    ],
    emotionalNote: [
      "Positive mood and emotional confidence are building toward their monthly peak.",
      "Emotional warmth and social confidence are rising strongly today.",
      "You likely feel emotionally grounded and socially at ease today.",
    ],
    actionTip: [
      "High-value tasks, hard decisions, and new projects fit well today.",
      "Use this window for work that requires sustained focus or creativity.",
      "Anything demanding — creative, social, or analytical — suits today perfectly.",
    ],
    tomorrowPreview: [
      "Day 9 continues the upward energy and focus trend.",
      "Tomorrow keeps building — you're heading toward your monthly peak.",
      "Day 9 brings even sharper focus as the pre-ovulatory window approaches.",
    ],
    energyLevel: "rising",
    focusLevel: "good",
  },
  {
    ...
    phase: "follicular",
    hormoneNote: [
      "Estrogen surges continue — ovulation is roughly five days away.",
      "Estrogen is near its peak buildup phase — performance is at its best.",
      "Pre-ovulatory estrogen surge is in full effect today.",
    ],
    physicalExpectation: [
      "Strength and endurance are near their monthly high today.",
      "Physical performance is at its best — training or demanding activity suits today.",
      "Energy and physical output are at peak levels right now.",
    ],
    mentalExpectation: [
      "Verbal fluency and social ease tend to peak in this window.",
      "This is your best window for communication, persuasion, or presentations.",
      "Language, connection, and social confidence are all at their highest.",
    ],
    emotionalNote: [
      "Social confidence and emotional warmth are near their monthly high today.",
      "Emotional openness and connection are at their strongest right now.",
      "This is one of the most emotionally positive days of your cycle.",
    ],
    actionTip: [
      "Collaborate, present, or tackle complex problems — conditions are optimal today.",
      "Use today for anything requiring communication, confidence, or social energy.",
      "Peak performance window — ideal for demanding or high-stakes activity.",
    ],
    tomorrowPreview: [
      "Day 10 brings peak pre-ovulatory energy and mental sharpness.",
      "Tomorrow is typically the clearest and most energetic day before ovulation.",
      "Day 10 is often the best focus and energy day of the entire cycle.",
    ],
    energyLevel: "high",
    focusLevel: "good",
  },
